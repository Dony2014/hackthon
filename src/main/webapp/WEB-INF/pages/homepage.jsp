...
<head>
 <style>
   #top{
	 ...
	 margin-top: 37px;
	 position: relative;
	 background-image: url(see_top.jpg);
   }
   ...
   #left{
	 ...
	 margin-top: -100px;
	 position: relative;
	 background-image: url(see_left.jpg);
   }
 ...
 <div id="right" name="right_div">
    ...
    pageNow=Integer.parseInt(s_pageNow);
      ...
      <c:forEach items="${files}" var="file">
       ...
       <td><button type="button" style="height:30px; background:#4169E1; color:white">share</td>
       </tr>
      </table>
    </div>
